# go-test-integration
[![Periodic Tests](https://github.com/zev-zakaryan/js-user-script/actions/workflows/integration-tests.yml/badge.svg)](https://github.com/zev-zakaryan/js-user-script/actions/workflows/integration-tests.yml)
