...
(function() {
  ...
  const oldXnewName={
    ...
    'tech-alert-apim-code-intelligence': ['🚨','Apim'],
    'Tech War room': ['🚨','War room'],
    'tech-alert-code-intelligence-nonprod': ['&nbsp;&nbsp;ℹ️','Coin alert np'],
    'tech-noti-code-intelligence': ['&nbsp;&nbsp;ℹ️','Coin'],
    'tech-noti-cicd-code-intelligence': ['&nbsp;&nbsp;ℹ️','Coin CiCd'],
    'tech-noti-newman-exporter': ['🤖','Newman'],
    'tech-team-code-intelligence': ['👥','Coin'],
    'Product support(PRI)': ['🌸','PRI'],
    'tech-team-tech-enabling-all-staffs': ['🌸','Enabling'],
    'tech-xteam-devops-codeintelligence': ['🌸','Devops'],
    'tech-proj-backstage': ['📁','Backstage⭐'],
    'tech-proj-ott-logger': ['📁','OttLog⭐'],
    'tech-proj-watch&earn-improvement': ['📁','Watch&Earn'],
    'trueid-tv-grafana-integration': ['📁','Tv-Grafana'],
    'X4 Gamification Working Team': ['📁','Gami'],
  }
